...
export const FireIcon: React.FC<IconProps> = ({ size = 18, className }) => (
  <svg
    ...
    className={className}
  >
    <path d="M12 23c-4.97 0-9-3.58-9-8 0-2.52 1.17-4.83 3.15-6.87.92-.95 1.95-1.78 3.03-2.48.53-.34 1.17-.54 1.82-.54.65 0 1.29.2 1.82.54 1.08.7 2.11 1.53 3.03 2.48C17.83 10.17 19 12.48 19 15c0 4.42-4.03 8-9 8zm0-18c-.22 0-.44.06-.63.17-.95.62-1.85 1.35-2.65 2.18C7.12 8.96 6 10.89 6 13c0 3.31 2.69 6 6 6s6-2.69 6-6c0-2.11-1.12-4.04-2.72-5.65-.8-.83-1.7-1.56-2.65-2.18A1.49 1.49 0 0 0 12 5z" />
  </svg>
)
